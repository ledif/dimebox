...
module.exports = function (opt) {
  ...
  const emptyResults = _.filter(parsedResults, result => { return result.observations.length == 0 })
  ...
  const nonEmptyResults = _.filter(parsedResults, result => { return result.observations.length > 0 })
